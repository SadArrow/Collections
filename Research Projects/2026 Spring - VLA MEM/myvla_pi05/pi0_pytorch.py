...
from .transformers_patch import maybe_disable_torch_compile_from_env
...
class PI0Pytorch(nn.Module):
    def __init__(self, config):
        ...
        if hasattr(torch, "compile") and not maybe_disable_torch_compile_from_env():
        ...
        msg = (
            ...
            "Install `transformers==4.53.2`, then copy `myVLA/vendor/transformers_replace/*` "
            "into your environment's `transformers/` package directory."
        )
        try:
