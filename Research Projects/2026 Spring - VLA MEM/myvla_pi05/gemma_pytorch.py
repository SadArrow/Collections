...
class PaliGemmaWithExpertModel(nn.Module):
    ...
    def embed_image(self, image: torch.Tensor):
        # MEM short-term memory may pass video frames as [B, T, C, H, W]. Prefer calling the vision tower
        # directly to avoid any shape assertions inside `get_image_features`, while still reusing the same
        # SigLIP + projector weights.
        if image.ndim == 5:
