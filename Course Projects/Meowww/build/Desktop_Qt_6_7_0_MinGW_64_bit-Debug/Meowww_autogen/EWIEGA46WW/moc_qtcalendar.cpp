/****************************************************************************
** Meta object code from reading C++ file 'qtcalendar.h'
**
...
#error "The header file 'qtcalendar.h' doesn't include <QObject>."
...
void Datewidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Datewidget::*)(QDate );
            if (_t _q_method = &Datewidget::updateCurrentDate; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Datewidget::updateCurrentDate(QDate _t1)
{
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSQTcalendarENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQTcalendarENDCLASS = QtMocHelpers::stringData(
    "QTcalendar",
    "DateSelectSignal",
    "",
    "date",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQTcalendarENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QTcalendar::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_CLASSQTcalendarENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQTcalendarENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQTcalendarENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QTcalendar, std::true_type>,
...
void QTcalendar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QTcalendar *>(_o);
        (void)_t;
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (QTcalendar::*)(QDate );
            if (_t _q_method = &QTcalendar::DateSelectSignal; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject *QTcalendar::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *QTcalendar::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQTcalendarENDCLASS.stringdata0))
        return static_cast<void*>(this);
    return QWidget::qt_metacast(_clname);
}

int QTcalendar::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QWidget::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
...
// SIGNAL 0
void QTcalendar::DateSelectSignal(QDate _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
    QMetaObject::activate(this, &staticMetaObject, 0, _a);
}
